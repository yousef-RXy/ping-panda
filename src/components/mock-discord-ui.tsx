      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="ml-auto flex items-center space-x-4 text-[#b9bbbe]">
            <Phone className="size-5 hover:text-white hidden sm:block" />
            <Video className="size-5 hover:text-white hidden sm:block" />
            <Pin className="size-5 hover:text-white hidden sm:block" />
            <UserCircle className="size-5 hover:text-white hidden sm:block" />
            <Search className="size-5 hover:text-white hidden sm:block" />
            <Inbox className="size-5 hover:text-white hidden sm:block" />
            <HelpCircle className="size-5 hover:text-white hidden sm:block" />
          </div>
        </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-5 hover:text-white hidden sm:block" />
              <Sticker className="size-5 hover:text-white hidden sm:block" />
              <Smile className="size-5 hover:text-white hidden sm:block" />
            </div>
          </div>
        </div>
      </div>
